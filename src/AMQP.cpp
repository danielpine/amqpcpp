...
void AMQP::showFunName(const char *name)
{
...
{
	//// showFunName(__FUNCTION__);
	//// std::cout << channels.empty() << std::endl;
	...
	//// std::cout << " amqp_connection_close |  " << cnn << std::endl;
	amqp_connection_close(cnn, AMQP_REPLY_SUCCESS);
	//// std::cout << " amqp_destroy_connection |  " << cnn << std::endl;
